/**
 * Wallet UI primitives — thin, brand-aware wrappers over @hanzo/gui.
 * Screens compose these; apps may use them directly too.
 */
...
export { QrView, type QrViewProps } from "./QrView"
